        ...
        <div class="footer-content">
            ...
            <div class="footer-menu">
              ...
              <ul id="menu-get-started" class="footer-menu-list">
                ...
                <li class="menu-item menu-item-type-post_type menu-item-object-product">
                  ...
                  <Link to='/*'>
                    <h6>Documentation Within Link  </h6>
                  </Link>
                ...
                <li class="menu-item menu-item-type-post_type menu-item-object-product">
                  ...
                  <Link to='/*'>
                    <h6>Installation Within Link  </h6>
                  </Link>
            ...
            <div class="footer-menu">
              ...
              <ul id="menu-legal" class="footer-menu-list">
                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-170434">
                  <Link to='#'>
                    <h7>Privacy Notice Within Link  </h7>
                  </Link>

                </li>
                <li class="menu-item menu-item-type-post_type menu-item-object-page">
                  <Link to='/*'>
                    <h7>Terms Within Link  </h7>
                  </Link>
          ...
          <div class="footer-content-column">
            <div class="footer-menu">
              ...
              <ul id="menu-quick-links" class="footer-menu-list">
                ...
                <li class="menu-item menu-item-type-custom menu-item-object-custom">
                  <Link to='/*'>
                    <h7>Service Status Within Link  </h7>
                  </Link>
                ...
                <Link to='/*'>
                  <h7>Customers Within Link  </h7>
                </Link>


                <li class="menu-item menu-item-type-post_type menu-item-object-page">
                  <Link to='/*'>
                    <h7>Reviews Within Link  </h7>
                  </Link>
                </li>
              </ul>
            </div>
          ...
          <div class="footer-content-column">
            <div class="footer-call-to-action">
              ...
              <Link to='/*'>
                <h7>Get in Touch Within Link  </h7>
              </Link>
        ...
        <div class="footer-copyright">
          <div class="footer-copyright-wrapper">
            <p class="footer-copyright-text">
              {/* <a class="footer-copyright-link" href="#" target="_self"> ©2023. | Designed By: Waheed Group Of Compnies | All rights reserved. </a> */}
              <a class="footer-copyright-link" href="#" target="_self"> ©2023. | Designed By: Waheed Group Of Compnies | All rights reserved. </a>
            </p>
          </div>
        </div>
