...
const Hotel = () => {
    return (
        ...
        //                 <div className="col-md-6 col-sm-12 col-12">
        //                     <div className="full-background background-right min-350 " style="background-image: url(uploads/laraibinn.jpg); position:relative; background-size:cover; max-height:650px;"></div>
        //                 </div>

        //                 <!--
        //                 <div className="col-md-6 col-sm-12 col-12">
        //                     <div className="full-background background-right min-350 " style="background-image: url(uploads/laraibinn.jpg); position:relative; background-size:cover; max-height:650px;">
        //                     </div>
        //                 </div>
        //  -->
