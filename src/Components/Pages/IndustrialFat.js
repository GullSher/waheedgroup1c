...
const IndustrialFat = () => {
    return (
        ...
        //                     <h4 className="semi-bold font-size-35" style="color:#083f88;">Industrial Fats</h4>
        //                 </div>
        ...
        //                         <ul>
        //                             <li><i className="fas fa-check-circle" style="color:blue;"></i> </li>
        //                             <li><i className="fas fa-check-circle" style="color:blue;"></i> </li>
        ...
        //         </div>
        //         <div className="col-md-6 col-sm-12 col-12">
        //             <div className="full-background background-right min-350 " style="background-image: url(uploads/industrialFat.jpg); position:relative; background-size:cover; max-height:650px;"></div>
        //         </div>
        //     </div>
        // </div>
