...
import Img3 from '../../AssetsMain/Uploads/awais.jpg';
import Img4 from '../../AssetsMain/Uploads/FaadWaheed.jpeg';
import Img5 from '../../AssetsMain/Uploads/oil-01.jpg';
const Director = () => {
    return (
        //     <div !--First -- >
            ...
            <div className="row no-gutters">
                ...
                <div className="col-md-6 col-sm-12 col-12">
                    <div className="full-background background-right min-350 "
                        style={{ backgroundImage: "url(" + Img3 + ")", position: 'relative', backgroundSize: 'cover', maxHeight: '650px' }}>
                    </div>
                </div>
                {/* </div> */}
                {/* </div> */}
                ...
                <div className="container-fluid pl-0 pr-0">
                    <div className="row no-gutters">
                        <div className="col-md-6 col-sm-12 col-12">
                            <div className="full-background background-right min-350 "
                                style={{ backgroundImage: "url(" + Img4 + ")", position: 'relative', backgroundSize: 'cover', maxHeight: '650px' }}>
                            </div>
                        </div>
                        <div className="col-md-6 col-sm-12 col-12">
                            <div className="padding-10-perc grey-bg background-80 background-no-repeat background-center">
                ...
                <div className="container-fluid pl-0 pr-0">
                    <div className="row no-gutters">
                        ...
                        <div className="col-md-6 col-sm-12 col-12">
                            <div className="full-background background-right min-350 " style={{ backgroundImage: "url(" + Img5 + ")", position: 'relative', backgroundSize: 'cover', maxHeight: '650px' }}>
                            </div>
                        </div>
                    </div >
                </div >
